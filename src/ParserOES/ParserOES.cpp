...
ParserOES::ParserOES()
    : _inited(false), _sink(NULL), _udp(false), _context(NULL)
{
}
...
void ParserOES::doOnConnected(MdsAsyncApiChannelT* pAsyncChannel)
{
    ...
    int32 dataTypes =
        MDS_SUB_DATA_TYPE_INDEX_SNAPSHOT | MDS_SUB_DATA_TYPE_OPTION_SNAPSHOT | MDS_SUB_DATA_TYPE_L2_SNAPSHOT | MDS_SUB_DATA_TYPE_L2_BEST_ORDERS | MDS_SUB_DATA_TYPE_L2_ORDER | MDS_SUB_DATA_TYPE_L2_SSE_ORDER | MDS_SUB_DATA_TYPE_L2_TRADE;
