...
{
    switch (ydError) {
    case YD_ERROR_NoError:
        return "NoError";
    case YD_ERROR_NoPositionToClose:
        return "NoPositionToClose";
    case YD_ERROR_NoMoneyToOpen:
        return "NoMoneyToOpen";
    case YD_ERROR_SystemNotReady:
        return "SystemNotReady";
    case YD_ERROR_OrderFieldError:
        return "OrderFieldError";
    case YD_ERROR_MemoryExceed:
        return "MemoryExceed";
    case YD_ERROR_NoTradingCodeInExchange:
        return "NoTradingCodeInExchange";
    case YD_ERROR_CanNotSendToExchange:
        return "CanNotSendToExchange";
    case YD_ERROR_NoTradingRight:
        return "NoTradingRight";
    case YD_ERROR_InvalidOrderVolume:
        return "InvalidOrderVolume";
    case YD_ERROR_InvalidClientAPP:
        return "InvalidClientAPP";
    case YD_ERROR_PositionLimitExceed:
        return "PositionLimitExceed";
    case YD_ERROR_TradeVolumeExceed:
        return "TradeVolumeExceed";
    case YD_ERROR_OrderCancelLimitExceed:
        return "OrderCancelLimitExceed";
    case YD_ERROR_OrderOpenLimitExceed:
        return "OrderOpenLimitExceed";
    case YD_ERROR_InvalidConnectionID:
        return "InvalidConnectionID";
    case YD_ERROR_AlreadyLogined:
        return "AlreadyLogined";
    case YD_ERROR_PasswordError:
        return "PasswordError";
    case YD_ERROR_TooManyRequests:
        return "TooManyRequests";
    case YD_ERROR_InvalidUsername:
        return "InvalidUsername";
    case YD_ERROR_InsertOrderTooFast:
        return "InsertOrderTooFast";
    case YD_ERROR_PossibleSelfTrade:
        return "PossibleSelfTrade";
    case YD_ERROR_NoAdminRight:
        return "NoAdminRight";
    case YD_ERROR_InvalidAddress:
        return "InvalidAddress";
    case YD_ERROR_OrderTypeNotSupported:
        return "OrderTypeNotSupported";
    case YD_ERROR_CancelOrderFieldError:
        return "CancelOrderFieldError";
    case YD_ERROR_InvalidExchange:
        return "InvalidExchange";
    case YD_ERROR_OrderNotFound:
        return "OrderNotFound";
    case YD_ERROR_OrderNotBelongToAccount:
        return "OrderNotBelongToAccount";
    case YD_ERROR_OrderFinished:
        return "OrderFinished";
    case YD_ERROR_OnlyLimitOrderCanBeCanceled:
        return "OnlyLimitOrderCanBeCanceled";
    case YD_ERROR_ClientReportError:
        return "ClientReportError";
    case YD_ERROR_TooManyOrders:
        return "TooManyOrders";
    case YD_ERROR_InstrumentCanNotTrade:
        return "InstrumentCanNotTrade";
    case YD_ERROR_YDOrderFlagNotSupported:
        return "YDOrderFlagNotSupported";
    case YD_ERROR_NotOptionInstrument:
        return "NotOptionInstrument";
    case YD_ERROR_PriceOutOfLimit:
        return "PriceOutOfLimit";
    case YD_ERROR_CrossPriceInQuote:
        return "CrossPriceInQuote";
    case YD_ERROR_QuoteFieldError:
        return "QuoteFieldError";
    case YD_ERROR_QuoteVolumeError:
        return "QuoteVolumeError";
    case YD_ERROR_QuoteNotFound:
        return "QuoteNotFound";
    case YD_ERROR_CancelQuoteFieldError:
        return "CancelQuoteFieldError";
    case YD_ERROR_QuoteNotBelongToAccount:
        return "QuoteNotBelongToAccount";
    case YD_ERROR_QuoteFinished:
        return "QuoteFinished";
    case YD_ERROR_QuoteNotSupported:
        return "QuoteNotSupported";
    case YD_ERROR_CannotCancelQuoteDerivedOrder:
        return "CannotCancelQuoteDerivedOrder";
    case YD_ERROR_TooManyLogines:
        return "TooManyLogines";
    case YD_ERROR_NoEnoughPositiontoMakeCombPosition:
        return "NoEnoughPositiontoMakeCombPosition";
    case YD_ERROR_NoEnoughCombPosition:
        return "NoEnoughCombPosition";
    case YD_ERROR_NoMoneyForSplitCombPosition:
        return "NoMoneyForSplitCombPosition";
    case YD_ERROR_InvalidCombPosition:
        return "InvalidCombPosition";
    case YD_ERROR_CannotSelectConnection:
        return "CannotSelectConnection";
    case YD_ERROR_SelectConnectionTooFrequently:
        return "SelectConnectionTooFrequently";
    case YD_ERROR_InvalidSelectConnection:
        return "InvalidSelectConnection";
    case YD_ERROR_TooLowApiVersion:
        return "TooLowApiVersion";
    case YD_ERROR_InvalidTradingRight:
        return "InvalidTradingRight";
    case YD_ERROR_InvalidProduct:
        return "InvalidProduct";
    case YD_ERROR_InvalidAlterMoneyField:
        return "InvalidAlterMoneyField";
    case YD_ERROR_TooHighApiVersion:
        return "TooHighApiVersion";
    case YD_ERROR_MoneyUsageTooLow:
        return "MoneyUsageTooLow";
    case YD_ERROR_InvalidInstrumentPairToExecuteTogether:
        return "InvalidInstrumentPairToExecuteTogether";
    case YD_ERROR_NotOnExpireDay:
        return "NotOnExpireDay";
    case YD_ERROR_NotProperTime:
        return "NotProperTime";
    case YD_ERROR_OptonLongPositionCostLimitExceed:
        return "OptonLongPositionCostLimitExceed";
    case YD_ERROR_PriceToTriggerFuse:
        return "PriceToTriggerFuse";
    case YD_ERROR_ExchangeDoesNotSupport:
        return "ExchangeDoesNotSupport";

    /// error numbers generated by ydAPI
    case YD_ERROR_CannotSend:
        return "CannotSend";
    case YD_ERROR_TooManyInMultiOrders:
        return "TooManyInMultiOrders";

    /// error numbers generated by exchanges
    case YD_ERROR_ExchangeReportError:
        return "ExchangeReportError";

    // 上期所的错误码
    case 1026:
        return "NotInTradingTime";
    case 1028:
        return "OrderAllTraded";
    default:
...
TraderYD::TraderYD()
    : m_pUserAPI(NULL), m_mapPosition(NULL), m_mapOrders(NULL), m_mapTrades(NULL), m_wrapperState(WS_NOTLOGIN), m_ayFunds(NULL), m_uLastQryTime(0), m_iRequestID(0), m_bCatchup(false), m_bStopped(false), m_bApiInited(false)
{
}
