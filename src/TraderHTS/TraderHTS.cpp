...
TraderHTS::TraderHTS()
    : m_wrapperState(WS_NOTLOGIN), m_uLastQryTime(0), m_bInQuery(false), m_bUseEX(false), m_bASync(false), m_strandIO(NULL), m_lastQryTime(0), m_orderRef(1), m_lDate(0), m_mapLives(NULL), m_bdMgr(NULL), m_traderSink(NULL)
{
