...
typedef struct _WTSEntrustStruct {
    ...
    _WTSEntrustStruct()
        : m_iPrice(0), m_dVolume(0), m_businessType(BT_CASH), m_direction(WDT_LONG), m_priceType(WPT_ANYPRICE), m_orderFlag(WOF_NOR), m_offsetType(WOT_OPEN), m_bIsNet(false), m_bIsBuy(true) {}
...
public:
    ...
    constexpr inline void setNetDirection(bool isBuy) noexcept
    {
        m_bIsNet = true;
        m_bIsBuy = isBuy;
    }
...
typedef struct _WTSActionStruct {
    ...
    _WTSActionStruct()
        : m_actionFlag(WAF_CANCEL), m_businessType(BT_CASH)
    {
    }
} WTSActionStruct;
...
typedef struct _WTSOrderStruct {
    ...
    _WTSOrderStruct()
        : m_orderState(WOS_Submitting), m_orderType(WORT_Normal), m_uInsertDate(0), m_uInsertTime(0), m_dVolTraded(0), m_dVolLeft(0), m_uErrorFlag(WOEF_None)
    {
    }
} WTSOrderStruct;
...
typedef struct _WTSTradeStruct {
    ...
    _WTSTradeStruct()
        : m_orderType(WORT_Normal), m_tradeType(WTT_Common), m_uAmount(0), m_dPrice(0), m_businessType(BT_CASH)
    {
    }
} WTSTradeStruct;
...
typedef struct _WTSPositionStruct {
    ...
    _WTSPositionStruct()
        : m_direction(WDT_LONG), m_dInitPosition(0), m_dPrePosition(0), m_dNewPosition(0), m_dAvailPrePos(0), m_dAvailNewPos(0), m_dMargin(0), m_dAvgPrice(0), m_dDynProfit(0), m_dTotalPosCost(0), m_businessType(BT_CASH)
    {
    }
} WTSPositionStruct;
...
typedef struct _WTSAccountStruct {
    ...
    _WTSAccountStruct()
        : m_strCurrency("CNY"), m_dBalance(0), m_dPreBalance(0), m_dCommission(0), m_dFrozenMargin(0), m_dFrozenCommission(0), m_dCloseProfit(0), m_dDynProfit(0), m_dDeposit(0), m_dWithdraw(0), m_dAvailable(0)
    {
    }
} WTSAccountStruct;
//////////////////////////////////////////////////////////////////////////
