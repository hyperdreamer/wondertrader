...
SelStraBaseCtx::SelStraBaseCtx(WtSelEngine* engine, const char* name, int32_t slippage)
    : ISelStraCtx(name), _engine(engine), _total_calc_time(0), _emit_times(0), _is_in_schedule(false), _ud_modified(false), _schedule_date(0), _schedule_time(0), _slippage(slippage)
{
