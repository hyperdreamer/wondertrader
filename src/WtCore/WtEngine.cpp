...
WtEngine::WtEngine()
    : _port_fund(NULL), _risk_volscale(1.0), _risk_date(0), _terminated(false), _evt_listener(NULL), _adapter_mgr(NULL), _notifier(NULL), _fund_udt_span(0), _ready(false)
{
