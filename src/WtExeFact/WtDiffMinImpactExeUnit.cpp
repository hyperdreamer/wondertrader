...
WtDiffMinImpactExeUnit::WtDiffMinImpactExeUnit()
    : _last_tick(NULL), _comm_info(NULL), _price_mode(0), _price_offset(0), _expire_secs(0), _cancel_cnt(0), _left_diff(0), _cancel_times(0), _last_place_time(0), _last_tick_time(0), _in_calc(false)
{
}
