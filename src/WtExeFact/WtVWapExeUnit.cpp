...
WtVWapExeUnit::WtVWapExeUnit()
    : _last_tick(NULL), _comm_info(NULL) // 品种信息
      ,
      _ord_sticky(0), _cancel_cnt(0), _channel_ready(false), _last_fire_time(0), _fired_times(0), _total_times(0), _total_secs(0), _price_mode(0), _price_offset(0), _target_pos(0), _cancel_times(0), _begin_time(0), _end_time(0), isCanCancel(true)
{
}
