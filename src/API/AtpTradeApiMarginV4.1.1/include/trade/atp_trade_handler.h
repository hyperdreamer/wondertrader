// code_generator_tag
// responses:af51694005ba077544b7de0fcc19c4e2 template:646dd51ff6f508acc67bffc451828387 code:cd9d59fba65398e088ce8cda23ba5f17
...
public:
    ...
    /**
     * @brief ETF信息查询结果
     * @param[in] ATPRspExtQueryResultETFInfoMsg
     * @type query
     */
    virtual void OnRspExtQueryResultETFInfo(const ATPRspExtQueryResultETFInfoMsg &msg){}

    /**
     * @brief ETF成分股信息查询结果
     * @param[in] ATPRspExtQueryResultETFComponentInfoMsg
     * @type query
     */
    virtual void OnRspExtQueryResultETFComponentInfo(const ATPRspExtQueryResultETFComponentInfoMsg &msg){}

    /**
     * @brief 新股中签结果查询结果
     * @param[in] ATPRspNewShareHitQueryResultMsg
     * @type query
     */
    virtual void OnRspNewShareHitQueryResult(const ATPRspNewShareHitQueryResultMsg &msg){}

    /**
     * @brief 网关用户密码修改应答
     * @param[in] ATPRspAgwUserPasswdModifyResultMsg
     * @type other
     */
    virtual void OnRspAgwUserPasswdModifyResult(const ATPRspAgwUserPasswdModifyResultMsg &msg){}

    /**
     * @brief 偿还明细查询结果
     * @param[in] ATPRspExtQueryResultRepaymentDetailMsg
     * @type query
     */
    virtual void OnRspExtQueryResultRepaymentDetail(const ATPRspExtQueryResultRepaymentDetailMsg &msg){}
};
