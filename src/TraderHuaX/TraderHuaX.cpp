...
TraderHuaX::TraderHuaX()
    : _api(NULL), _sink(NULL), _ordref(makeRefID()), _reqid(1), _accounts(NULL), _orders(NULL), _trades(NULL), _positions(NULL), _bd_mgr(NULL), _tradingday(0), _inited(false), _terminal("PC"), _encrypt(false), _flowdir("HuaXTDFlow")
{
}
